...
(function (global) {
  ...
  const CFG = {
    ...
    palettes: {
      /* 4 ألوان لعُقد الشبكة — كلهم من عائلة التيل/السيان نفسها (بدون بنفسجي) */
      dark:  [[18,240,192],[10,156,128],[76,224,255],[57,255,157]],
      light: [[0,120,107],[0,89,79],[0,119,163],[10,143,95]],
    },
  };
